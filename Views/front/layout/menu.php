...
<nav class="nav-menu d-none d-lg-block">
    <ul>
        ...
        <li><a href="https://learning.smansamaliku.sch.id/" target=_blank> LMS SMAN 1 Maliku</a></li>
        <li><a href="https://spmb.smansamaliku.sch.id/" target="_blank" rel="nofollow">SPMB 2026</a></li>
        <li><a href="#footer">Contact</a></li>
        <li><a href="<?= base_url('home/cekspp') ?>">Cek SPP</a></li>

    </ul>
</nav><!-- .nav-menu -->
<a href="<?= base_url('kelulusan') ?>" class="get-started-btn">Pengumuman Kelulusan</a>
...
<section id="counts" class="counts section-bg">
    <div class="container">
        ...
        <div class="row counters">
            ...
            <div style="background-color: deepskyblue;" class="col-lg-3 col-6 text-center">
                <span data-toggle="counter-up"><?= $staf['staf_id'] ?></span>
                <p>Staf</p>
            </div>

            <div style="background-color: gold;" class="col-lg-3 col-6 text-center">
                <span data-toggle="counter-up"><?= $guru['guru_id'] ?></span>
                <p>Guru</p>
            </div>

            <div style="background-color: orange;" class="col-lg-3 col-6 text-center">
                <span data-toggle="counter-up"><?= $kelas['kelas_id'] ?></span>
                <p>Kelas</p>
            </div>

            <div style="background-color: aqua;" class="col-lg-3 col-6 text-center">
